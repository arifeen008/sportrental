                    ...
                    <div class="card-body p-4">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <h5>ข้อมูลผู้จอง</h5>
                                <ul class="list-unstyled">
                                    <li><i class="fas fa-user fa-fw me-2 text-muted"></i><strong>ชื่อ:</strong>
                                        {{ Auth::user()->name }}</li>
                                    <li><i class="fas fa-envelope fa-fw me-2 text-muted"></i><strong>อีเมล:</strong>
                                        {{ Auth::user()->email }}</li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class="list-group list-group-flush summary-list">
                            ...
                            @else
                                ...
                                <div class="list-group-item d-flex justify-content-between align-items-center text-success">
                                    <span><i class="fas fa-tags me-1"></i>
                                        {{ $summary['discount_reason'] ?? 'ส่วนลด' }}</span>
