...
<head>
    ...
    <style>
        ...
        .sidebar { width: 260px; background-color: #212529; color: white; }
...
<body>
    <div class="sidebar p-3 d-flex flex-column flex-shrink-0">
        ...
        <ul class="nav nav-pills flex-column mb-auto">
            ...
            <li class="nav-item mb-1">
                <a href="#" class="nav-link text-white"> <i class="fas fa-calendar-alt fa-fw me-2"></i> จัดการการจอง </a>
            </li>
            <li class="nav-item mb-1">
                <a href="{{ route('admin.memberships.index') }}" class="nav-link text-white {{ request()->routeIs('admin.memberships.*') ? 'active' : '' }}">
                    <i class="fas fa-id-card fa-fw me-2"></i> จัดการสมาชิก
                </a>
            </li>
        </ul>
        <hr>
