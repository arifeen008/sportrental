        ...
        <div class="row justify-content-center">
            <div class="col-lg-10">
                ...
                <div class="alert alert-info mt-4">
                    ...
                    <ul class="mb-0">
                        <li><strong>ค่ามัดจำ:</strong> กรุณาชำระเงินมัดจำ **50%** ในวันที่ทำการจอง เพื่อยืนยันสิทธิ์</li>
                        <li><strong>การชำระส่วนที่เหลือ:</strong> ชำระยอดที่เหลือทั้งหมดพร้อม **เงินประกันสนาม 2,000 บาท**
                            ล่วงหน้าอย่างน้อย 5 วันก่อนวันใช้บริการ</li>
                        <li><strong>การเลื่อนวัน:</strong> สามารถขอเลื่อนวันใช้บริการได้ 1 ครั้ง
                            โดยต้องแจ้งล่วงหน้าอย่างน้อย 3 วัน</li>
                        <li>ทางสนามขอสงวนสิทธิ์ในการ **ไม่คืนเงินมัดจำ** ในกรณียกเลิกการจอง</li>
