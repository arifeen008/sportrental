                    ...
                    <div class="card shadow-sm mb-4 text-white"
                        ...
                        <div class="card-body p-4">
                            <div class="d-flex justify-content-between align-items-start">
                                <div>
                                    <h5 class="card-title"><?php echo e($activeMembership->membershipTier->tier_name); ?></h5>
                                    <p class="card-text small text-white-50"><?php echo e($activeMembership->card_number); ?></p>
                                </div>
                            ...
                            <div class="my-4">
                                ...
                                <div class="progress" style="height: 20px;">
                                    ...
                                    <div class="progress-bar" role="progressbar" style="width: <?php echo e($percentage); ?>%;"
                                        aria-valuenow="<?php echo e($activeMembership->remaining_hours); ?>" aria-valuemin="0"
                                        aria-valuemax="<?php echo e($activeMembership->initial_hours); ?>">
                                        <?php echo e(number_format($activeMembership->remaining_hours)); ?> ชม.
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="d-flex justify-content-between align-items-end">
                                ...
                                <div>
                                    ...
                                    <h6 class="mb-0"><?php echo e(thaidate('j M Y', $activeMembership->expires_at)); ?></h6>
                                </div>
                            </div>
                        </div>
                ...
                <?php else: ?>
                    ...
                    <div class="card shadow-sm mb-4">
                        <div class="card-body text-center p-5">
                            ...
                            <a href="<?php echo e(route('user.purchase.index')); ?>" class="btn btn-primary">
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                ...
                                                <?php else: ?>
                                                    ...
                                                    <a href="<?php echo e(route('user.booking.show', $booking)); ?>"
