...
<?php $__env->startSection('content'); ?>
                                ...
                                <tbody>
                                    ...
                                    <?php $__empty_1 = true; $__currentLoopData = $bookings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $booking): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <tr>
                                            ...
                                            <td><?php echo e(thaidate('j F Y', $booking->booking_date)); ?></td>
                                            ...
                                            <td class="text-center">
                                                <?php if($booking->payment_status == 'unpaid'): ?>
                                                    <button class="btn btn-sm btn-primary" data-bs-toggle="modal"
                                                        data-bs-target="#uploadSlipModal-<?php echo e($booking->booking_code); ?>">
    ...
    <?php $__currentLoopData = $bookings->where('payment_status', 'unpaid'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $booking): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <div class="modal fade" id="uploadSlipModal-<?php echo e($booking->booking_code); ?>" tabindex="-1" aria-hidden="true">
                ...
                <div class="modal-content">
                    ...
                    <form action="<?php echo e(route('user.booking.uploadSlip', $booking->id)); ?>" method="POST"
                        ...
                        <div class="modal-header">
                            <h5 class="modal-title">อัปโหลดสลิปสำหรับ #<?php echo e($booking->booking_code); ?></h5>
                        ...
                        <div class="modal-body">
                            <p>ยอดชำระ: <strong class="text-danger"><?php echo e(number_format($booking->total_price, 2)); ?>
                                    ...
                                    บาท</strong></p>
                            <div class="mb-3">
                                <label for="slipImage-<?php echo e($booking->booking_code); ?>" class="form-label">เลือกไฟล์รูปภาพสลิป</label>
                                <input class="form-control" type="file" name="slip_image"
                                    id="slipImage-<?php echo e($booking->booking_code); ?>" required>
                            </div>
                        </div>
