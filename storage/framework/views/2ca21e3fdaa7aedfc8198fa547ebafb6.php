                    ...
                    <div class="card-body p-4">
                        <form action="<?php echo e(route('user.booking.confirm')); ?>" method="POST">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-12">
                                    ...
                                    <input type="date" class="form-control" name="booking_date" id="booking_date_hourly"
                                        value="<?php echo e(now()->format('Y-m-d')); ?>" min="<?php echo e(now()->format('Y-m-d')); ?>" required>
                                </div>
                                <div class="col-md-6">
                            ...
                            <div class="d-flex justify-content-between align-items-center mt-4 pt-3 border-top">
                                <a href="<?php echo e(route('user.dashboard')); ?>" class="btn btn-secondary btn-lg">&laquo;กลับแดชบอร์ด</a>
                    ...
                    <div class="card-body p-0">
                        <div class="table-responsive">
                            <table class="table table-striped table-hover mb-0">
                                ...
                                <tbody>
                                    <?php $__empty_1 = true; $__currentLoopData = $confirmedBookings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $booking): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <tr>
                                            <td><?php echo e(thaidate('d M y', $booking->booking_date)); ?></td>
                                            <td><?php echo e(\Carbon\Carbon::parse($booking->start_time)->format('H:i')); ?> -
                                                <?php echo e(\Carbon\Carbon::parse($booking->end_time)->format('H:i')); ?></td>
                                            <td><?php echo e(optional($booking->fieldType)->name ?? 'เหมา'); ?></td>
                                        </tr>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function performAvailabilityCheck() {
                ...
                debounceTimer = setTimeout(() => {
                    ...
                    fetch('<?php echo e(route('api.booking.checkAvailability')); ?>', {
                            method: 'POST',
                            headers: {
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\sportsrental\resources\views/user/booking/create_hourly.blade.php ENDPATH**/ ?>